...
//go:embed code_review.prompt
var codeReviewPrompt string

func (m MasonLlm) ReviewCode(
	ctx context.Context,
	...
	if isNull, err := env.Output("result").IsNull(ctx); isNull || err != nil {
		env = env.WithStringOutput("result", "The result of your code review, in Markdown format.")
	}
